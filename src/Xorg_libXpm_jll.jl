...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXpm_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1a3ddb2d-74e3-57f3-a27b-e9b16291b4f2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_libXpm", artifacts_toml) for e in artifacts["Xorg_libXpm"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXpm; unsupported platform $(triplet(platform_key_abi()))")
else
